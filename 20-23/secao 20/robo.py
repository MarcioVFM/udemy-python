class Robo:
    ...
    def dizer_nome(self):
        ...
        return 'EU NAO TENHO BATERIA O SUFICIENTE PARA ISSO'
    ...
    def aprender_habilidade(self, nova_habilidade, custo):
        if self.__bateria >= custo:
            ...
            return f'UAUAU! APRENDI A INCRIVEL HABILIDADE {nova_habilidade.upper()}'
        return f'EU NAO TENHO BATERIA O SUFICIENTE PARA APRENDER A HABILIDADE {nova_habilidade.upper()}'
